...
\textbf{consulta original 1: } the crystalline lens in vertebrates, including humans.


\begin{figure}
	\begin{center}
		\includegraphics[width=\linewidth]{ ./images/v-med-q1.png}
		\caption{ Id de consulta: 1 Dataset: Medline }
		\label{vect_q1}
	\end{center}
\end{figure}


\textbf{consulta original 4: } can a criterion be developed to show empirically the validity of flow solutions for chemically reacting gas mixtures based on the simplifying assumption of instantaneous local chemical equilibrium 

\begin{figure}
	\begin{center}
		\includegraphics[width=\linewidth]{ ./images/v-cran-q4.png}
		\caption{ Id de consulta: 4 Dataset: Cranfield }
		\label{vect_q4}
	\end{center}
\end{figure}
...
A continuación se muestran ejemplos de consultas realizadas 
